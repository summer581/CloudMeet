...
bool ChatMessage::s_darkTheme = true;

void ChatMessage::setDarkTheme(bool dark)
{
    s_darkTheme = dark;
}

bool ChatMessage::isDarkTheme()
{
    return s_darkTheme;
}
...
void ChatMessage::paintEvent(QPaintEvent *event)
{
    ...
    if(m_userType == User_Type::User_She) { // 用户
        ...
        QColor col_KuangB = s_darkTheme ? QColor(51, 65, 85) : QColor(209, 213, 219);
        QColor col_Kuang  = s_darkTheme ? QColor(30, 41, 59) : QColor(243, 244, 246);
        QColor col_Ip     = s_darkTheme ? QColor(100, 116, 139) : QColor(107, 114, 128);
        QColor col_Text   = s_darkTheme ? QColor(226, 232, 240) : QColor(31, 41, 55);
        ...
        QColor col_Kuang  = s_darkTheme ? QColor(180, 83, 9) : QColor(59, 130, 246);
        QColor col_Ip     = s_darkTheme ? QColor(148, 163, 184) : QColor(107, 114, 128);
        QColor col_Text   = s_darkTheme ? QColor(255, 255, 255) : QColor(255, 255, 255);
        ...
        QPen penText;
        penText.setColor(s_darkTheme ? QColor(100,116,139) : QColor(156, 163, 175));
        painter.setPen(penText);
